...
// 去斜杠
function _end(str = ``) {return str.replace(/\/$/g,``)}
function _double(str = ``) {return str.replace(/\/\//g,`/`)}
function _start(str = ``) {return str.replace(/^\//g,``)}
function _domain(str = ``) {return _start(str)}
function _path(str = ``) {return _double(_end(str))}
